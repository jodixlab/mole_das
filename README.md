...
- Portable and installer bundle ZIPs are now distinct payloads: the portable ZIP contains the direct-run shareable payload, while the installer ZIP contains the curated root install package
